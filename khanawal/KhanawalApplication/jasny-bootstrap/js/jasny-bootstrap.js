...
!function ($) {
  ...
  * ================================= */
  ...
  var Inputmask = function (element, options) {
    ...
    keydownEvent: function(e) {
      var k=e.which; //backspace, delete, and escape get special treatment
    ...
    checkVal: function(allow) {
      var len = this.mask.length; //try to place characters where they belong
  ...
  * =========================== */
  ...
  $.fn.inputmask = function (options) {
    ...
    $.fn.inputmask.Constructor = Inputmask; /* INPUTMASK DATA-API
  * ================== */
...
!function ($) {
  ...
  * =========================== */
  ...
  $.fn.rowlink = function (options) {
    ...
    $.fn.rowlink.Constructor = Rowlink; /* ROWLINK DATA-API
  * ================== */
...
!function ($) {
    ...
    Fileupload.prototype = {
        ...
        change: function (e, invoked) {
            ...
            if (this.type === "image" && this.$preview.length > 0 && (typeof file.type !== "undefined" ? file.type.match('image.*') : file.name.match('\\.(gif|png|jpe?g)$')) && typeof FileReader !== "undefined") {
                ...
                preview.html('<img src="' + "file:///" + e.target.value + '" ' + (preview.css('max-height') != 'none' ? 'style="max-height: ' + preview.css('max-height') + ';"' : '') + ' />');
                element.addClass('fileupload-exists').removeClass('fileupload-new');
            }
        },
  ...
  * =========================== */
    ...
    $.fn.fileupload.Constructor = Fileupload; /* INPUTMASK DATA-API
  * ================== */
